...
-- Insert test product for payments (using proper UUID)
INSERT INTO public.products (name_ru, name_kk, price, description_ru) VALUES 
('Тестовый товар', 'Тест өнім', 1.00, 'Тестовый товар для проверки оплаты');