              ...
              <div className="prose prose-lg max-w-none">
                {language === 'ru' ? (
                  <>
                    ...
                    <p>
                      Вы можете самостоятельно забрать заказанные товары с нашего склада в Алматы. Самовывоз осуществляется после 100% предоплаты и по предварительному согласованию с менеджером.
                    </p>
                  ...
                  <>
                    ...
                    <h2 className="text-2xl font-bold mt-8 mb-4">Өзі алып кету</h2>
                    <p>
                      Сіз тапсырыс берілген тауарларды Алматыдағы біздің қоймамыздан өзіңіз алып кете аласыз. Өзі алып кету 100% алдын ала төлемнен кейін және менеджермен алдын ала келісім бойынша жүзеге асырылады.
                    </p>
